...
module Kafka
  class Client
    ...
    def initialize(seed_brokers:, client_id: "ruby-kafka", logger: nil, connect_timeout: nil, socket_timeout: nil,
                   ...
                   sasl_oauth_client_id: nil, sasl_oauth_client_secret: nil, sasl_oauth_server_url: nil, sasl_oauth_token_url: nil, sasl_oauth_scopes: [])
      ...
      sasl_authenticator = SaslAuthenticator.new(
        ...
        sasl_oauth_scopes: sasl_oauth_scopes,
        logger: @logger
      )
